...
Durable knowledge for Claude sessions on Dealflow, version-controlled so it's
shared across machines and contributors. One file per fact.

Enforced conventions live in `CLAUDE.md` (that's the prompt); this dir keeps the
portable reference/feedback notes. Public repo — keep it scrubbed (no real tags,
links, JIDs, tokens; use placeholders).
