Required Notice: Copyright © 2026 Leonardo Diniz (Dealflow)

Required Notice: "Dealflow", its name and logo, are not licensed. Forks and
distributions must use a different name.
